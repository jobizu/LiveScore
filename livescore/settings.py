"""
Django settings for livescore project.
...
SECRET_KEY = 'django-insecure-*a(#sd2&27l$9dnz^4cy(tvs+=+n(uf+g5yfg)h!km=zd$0%op'
...
API_FOOTBALL_TIMEOUT = int(os.environ.get('API_FOOTBALL_TIMEOUT', '20'))
