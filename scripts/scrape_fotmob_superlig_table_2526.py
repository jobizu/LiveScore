...
SOURCE_URL = "https://www.fotmob.com/leagues/71/table/super-lig"
DEFAULT_OUTPUT = Path("data/superlig_fotmob_table_2025_2026.csv")
OUTPUT_HEADERS = [
    "Position",
    "Team",
    "TeamId",
...
def parse_table_rows(next_data: dict) -> list[dict[str, str]]:
    ...
    if not standings:
        raise ValueError("No Super Lig standings rows found in FotMob payload.")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Scrape FotMob Turkiye Super Lig table and team logo URLs into CSV."
    )
...
def main() -> int:
    ...
    print(f"Saved FotMob Super Lig table CSV to: {args.output.resolve()}")
